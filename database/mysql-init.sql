...
('store-2', 'Жидкое Золото - Север', 'пр. Мира, 128', '+7 (495) 234-56-78', '10:00 - 23:00', 'user-3'),
('store-3', 'Жидкое Золото - Юг', 'ул. Южная, 15', '+7 (495) 345-67-89', '11:00 - 22:00', 'user-4');
...
('prod-2', 'Балтика 7 Экспортное', 'lager', 'Балтика', 'Россия', 5.4, 22, 'Премиальный лагер европейского качества', 150),
('prod-3', 'Guinness Draught', 'dark', 'Diageo', 'Ирландия', 4.2, 45, 'Легендарный ирландский стаут с кремовой пеной', 320);
